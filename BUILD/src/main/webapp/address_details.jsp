...
<div class="container">
    <div class="address-details">
        ...
        <%-- Display user address details here --%>
        <%-- If details are present, show them --%>
        <%
            String currentAddress = (String) request.getAttribute("currentAddress");
            String currentPincode = (String) request.getAttribute("currentPincode");
            String permanentAddress = (String) request.getAttribute("permanentAddress");
            String permanentPincode = (String) request.getAttribute("permanentPincode");

            if (currentAddress != null && currentPincode != null && permanentAddress != null && permanentPincode != null) {
        %>
            <p><strong>Current Address:</strong> <%= currentAddress %></p>
            <p><strong>Current Pincode:</strong> <%= currentPincode %></p>
            <p><strong>Permanent Address:</strong> <%= permanentAddress %></p>
            <p><strong>Permanent Pincode:</strong> <%= permanentPincode %></p>
            <button onclick="location.href='UpdateAddress.jsp'" class="update-btn">Update Address</button> 
           
        <% } else { %>
            <p>No address details found.</p>
            <a href="enter_address.jsp">Enter Address Details</a>
        <% } %>
    </div>
</div>
