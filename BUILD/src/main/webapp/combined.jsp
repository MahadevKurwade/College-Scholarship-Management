...
<div class="container" style="background-image: url('https://www.wirelesscs.com/storage/app/public/P4KWX1MNn0nmzZ7lrbkOkxeg5wBUgk-metaY2FyZWVyLmpwZw==-.jpg');">
    <h2>Fill All Details..</h2>
    <div class="button-group">
        <form action="PersonalDetailsServlet" method="post">
            <button class="module-button"> View Personal Detail</button>
        </form>
        <form action="AddressDetailsServlet" method="post">
            <button class="module-button"> View Address Detail</button>
        </form>
        <form action="BankDetailsServlet" method="post">
            <button class="module-button"> View Bank Detail</button>
        </form>
        <form action="CheckStudentEducationServlet" >
            <button class="module-button"> Student Education Details</button>
        </form>
        <form action="dashboard.jsp">
            <button class="module-button">dashboard</button>
        </form>
    </div>
</div>
